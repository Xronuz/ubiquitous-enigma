  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-2xl border-0 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100',
        'shadow-dialog',
        // Animations
